...
export function Hero() {
    return (
        <section id="home" className="z-10 relative flex flex-col justify-center items-center bg-[url(/assets/img/zaluzie.jpg)] bg-cover bg-center w-full min-h-screen text-white animate-bg-zoom-out">
